  ...
  function searchNotice() {
      ...
      if (validate) {
        ...
        */
        ...
        noticeareavar.formerDate = formerDate;
        noticeareavar.latterDate = latterDate;
      option = noticeareavar.option;
      keyword = noticeareavar.keyword;
      formerDate = noticeareavar.formerDate;
      latterDate = noticeareavar.latterDate;
...
*/
  ...
  function selectListCallBack(result, currentPage) {
    ...
    //alert(JSON.stringify(result.noticeList[0].title));
            ...
            <div class="content">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="input-group">
                      <select style="width: 90px; height: 34px;" id="option" v-model="option">
                        <option value="all" selected>전체</option>
                        <option value="title" id="title">제목</option>
                        <option value="content" id="content">내용</option>
                      </select> <input type="text" class="form-control" aria-label="..." id="keyword" autocomplete="off" v-model="keyword">
                    </div>
                  </div>
                  <!-- // searchbar -->
                  <!-- datepicker -->
                  <div class='col-md-3 col-xs-4'>
                    <div class="form-group">
                      <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                        <input type="text" id="formerDate" v-model="formerDate" class="form-control datetimepicker-input" data-target="#datetimepicker1" value="">
                  ...
                  <div class='col-md-3 col-xs-4'>
                    <div class="form-group">
                      <div class="input-group date" id="datetimepicker3" data-target-input="nearest">
                        <input type="text" v-model="latterDate" class="form-control datetimepicker-input" data-target="#datetimepicker3" value="">
                  ...
                  <div class="btn-group" role="group" aria-label="...">
                    <button type="button" class="btn btn-default" id="search_button" @click="searchButton">검색</button>
                  </div>
                  <!-- // button -->
                </div>
                <!-- /.row -->
              ...
              <div class="divComGrpCodList">
                <table class="col">
                  ...
                  <tbody id="listInf" v-for="item in listitem" v-if="listitem.length">
        ...
        <dd class="content">
          <table class="row">
            ...
            <tbody>
              <tr>
                <th scope="row">제목</th>
                <td colspan="3"><input type="text" class="inputTxt p100" name="notice_title" id="notice_title" v-model="noticeTitle" autocomplete="off" @change=""method placeholder="최대 100자까지 입력 가능합니다" required /></td>
              </tr>
